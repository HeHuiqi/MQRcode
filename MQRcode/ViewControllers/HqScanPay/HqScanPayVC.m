...
#pragma mark - 扫码成功
- (void)scanSuccess:(NSString *)payCode{
    NSString *url = [NSString stringWithFormat:@"/transactions/orders/%@",_merchantOrderNo];
    NSDictionary *param = @{@"payCode": payCode};
