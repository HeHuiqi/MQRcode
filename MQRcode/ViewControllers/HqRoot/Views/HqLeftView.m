...
- (void)initData{
    _titles = @[@{@"icon":@"home_icon",@"title":@"Home"},
                ...
                @{@"icon":@"modify_password_icon",@"title":@"Modify password"},
                @{@"icon":@"trade_icon",@"title":@"Transaction record"},
                @{@"icon":@"push_icon",@"title":@"Push-notification"},
...
- (UISwitch *)chooseSwitch{
    ...
    [hqSwitch addTarget:self action:@selector(hqOpenPushCard:) forControlEvents:UIControlEventValueChanged];
    hqSwitch.on = YES;
    return hqSwitch;
}
- (void)hqOpenPushCard:(UISwitch *)hqSwitch{
