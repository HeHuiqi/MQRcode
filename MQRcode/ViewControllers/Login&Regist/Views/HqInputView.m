...
- (void)setPlacehoder:(NSString *)placehoder color:(UIColor *)color{
    
    NSMutableAttributedString *atr = [[NSMutableAttributedString alloc]initWithString:placehoder];
    [atr addAttribute:NSForegroundColorAttributeName value:[UIColor whiteColor] range:NSMakeRange(0, placehoder.length)];
